...
namespace AgencijaZaNekretnine.Data.DataAccess
{
    public class MySqlUtil
    {
        private static readonly string connectionString = "Server=localhost;Port=3306;Database=nekretnine_database;UserId=root;Password=root;";
